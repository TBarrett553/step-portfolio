...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeNotConsidered() {
    ...
    // split the restricted times. There is an optional attendee and their event isn't considered.
    //
    // OptEvent: |-------------C---------------|
    // Events  :       |--A--|     |--B--|     
    // Day     : |-----------------------------|
  ...
  public void optionalAttendeeConsidered() {
      // Have each person have different events. We should see three options because each person has
    // split the restricted times. There is an optional attendee and their event is considered.
    //
    // OptEvent: |-------------C---------------|
    // Events  :       |--A--|     |--B--|     
    // Day     : |-----------------------------|
  ...
  public void justEnoughRoomForRequiredAttendees() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting. There is an optional attendee whose smaller meeting isn't considered.
    //
    // OptEVent:       |-B-|
    // Events  : |--A--|     |----A----|
    // Day     : |---------------------|
